...
void CapturingBeep(){                       //Beep when Team 1 captures the flag
  digitalWrite(5, HIGH);
  delay(500);
  digitalWrite(5, LOW);
}
...
void Team1Display(){                           //Void to display in the 1st LCD Team 1's name
  lcd1.setCursor(4,0);
  lcd1.print("Equipo 1");
}

void Team2Display(){                           //Void to display in the 2nd LCD Team 2's name
  lcd2.setCursor(4,0);
  lcd2.print("Equipo 2");
}
